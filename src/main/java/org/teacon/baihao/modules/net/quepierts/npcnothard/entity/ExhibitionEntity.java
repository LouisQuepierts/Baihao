...
public abstract class ExhibitionEntity extends PathfinderMob {
    ...
    public @Nullable ItemStack getPickResult() {
        ...
        if (result != null) {
            result.set(NpcNHDataComponents.EXHIBITION_NODES, this.getExhibitionNode().toImmutable());
    ...
    static {
        DATA_NODE = SynchedEntityData.defineId(ExhibitionEntity.class, NpcNHEntities.EXHIBITION_NODE.get());
    }
